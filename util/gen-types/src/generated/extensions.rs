...
impl RelayMessage {
    ...
    pub const ITEMS_COUNT: usize = 13;
    ...
    pub fn to_enum(&self) -> RelayMessageUnion {
        ...
        match self.item_id() {
            ...
            8 => RelayTransactionSalt::new_unchecked(inner).into(),
            9 => GetRelayTransactionSketch::new_unchecked(inner).into(),
            10 => RelayTransactionSketch::new_unchecked(inner).into(),
            11 => GetRelayTransactionExtendedSketch::new_unchecked(inner).into(),
            12 => RelayTransactionSketchResult::new_unchecked(inner).into(),
...
impl<'r> RelayMessageReader<'r> {
    ...
    pub fn to_enum(&self) -> RelayMessageUnionReader<'r> {
        ...
        match self.item_id() {
            ...
            8 => RelayTransactionSaltReader::new_unchecked(inner).into(),
            9 => GetRelayTransactionSketchReader::new_unchecked(inner).into(),
            10 => RelayTransactionSketchReader::new_unchecked(inner).into(),
            11 => GetRelayTransactionExtendedSketchReader::new_unchecked(inner).into(),
            12 => RelayTransactionSketchResultReader::new_unchecked(inner).into(),
            _ => panic!("{}: invalid data", Self::NAME),
        }
    }
}
impl<'r> molecule::prelude::Reader<'r> for RelayMessageReader<'r> {
    ...
    fn verify(slice: &[u8], compatible: bool) -> molecule::error::VerificationResult<()> {
        ...
        match item_id {
            ...
            8 => RelayTransactionSaltReader::verify(inner_slice, compatible),
            9 => GetRelayTransactionSketchReader::verify(inner_slice, compatible),
            10 => RelayTransactionSketchReader::verify(inner_slice, compatible),
            11 => GetRelayTransactionExtendedSketchReader::verify(inner_slice, compatible),
            12 => RelayTransactionSketchResultReader::verify(inner_slice, compatible),
...
pub enum RelayMessageUnion {
    ...
    RelayTransactionSalt(RelayTransactionSalt),
    GetRelayTransactionSketch(GetRelayTransactionSketch),
    RelayTransactionSketch(RelayTransactionSketch),
    GetRelayTransactionExtendedSketch(GetRelayTransactionExtendedSketch),
    RelayTransactionSketchResult(RelayTransactionSketchResult),
}
...
pub enum RelayMessageUnionReader<'r> {
    ...
    RelayTransactionSalt(RelayTransactionSaltReader<'r>),
    GetRelayTransactionSketch(GetRelayTransactionSketchReader<'r>),
    RelayTransactionSketch(RelayTransactionSketchReader<'r>),
    GetRelayTransactionExtendedSketch(GetRelayTransactionExtendedSketchReader<'r>),
    RelayTransactionSketchResult(RelayTransactionSketchResultReader<'r>),
}
...
impl ::core::fmt::Display for RelayMessageUnion {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            ...
            RelayMessageUnion::RelayTransactionSalt(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
                    RelayTransactionSalt::NAME,
                    item
                )
            }
            RelayMessageUnion::GetRelayTransactionSketch(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
                    GetRelayTransactionSketch::NAME,
                    item
                )
            }
            RelayMessageUnion::RelayTransactionSketch(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
                    RelayTransactionSketch::NAME,
                    item
                )
            }
            RelayMessageUnion::GetRelayTransactionExtendedSketch(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
                    GetRelayTransactionExtendedSketch::NAME,
                    item
                )
            }
            RelayMessageUnion::RelayTransactionSketchResult(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
                    RelayTransactionSketchResult::NAME,
                    item
                )
            }
        }
...
impl<'r> ::core::fmt::Display for RelayMessageUnionReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            ...
            RelayMessageUnionReader::RelayTransactionSalt(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
            ...
            RelayMessageUnionReader::GetRelayTransactionSketch(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
            ...
            RelayMessageUnionReader::RelayTransactionSketch(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
            ...
            RelayMessageUnionReader::GetRelayTransactionExtendedSketch(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
            ...
            RelayMessageUnionReader::RelayTransactionSketchResult(ref item) => {
                write!(
                    f,
                    "{}::{}({})",
                    Self::NAME,
...
impl RelayMessageUnion {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            ...
            RelayMessageUnion::RelayTransactionSalt(ref item) => write!(f, "{}", item),
            RelayMessageUnion::GetRelayTransactionSketch(ref item) => write!(f, "{}", item),
            RelayMessageUnion::RelayTransactionSketch(ref item) => write!(f, "{}", item),
            RelayMessageUnion::GetRelayTransactionExtendedSketch(ref item) => write!(f, "{}", item),
            RelayMessageUnion::RelayTransactionSketchResult(ref item) => write!(f, "{}", item),
        }
    }
}
impl<'r> RelayMessageUnionReader<'r> {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            ...
            RelayMessageUnionReader::RelayTransactionSalt(ref item) => write!(f, "{}", item),
            RelayMessageUnionReader::GetRelayTransactionSketch(ref item) => write!(f, "{}", item),
            RelayMessageUnionReader::RelayTransactionSketch(ref item) => write!(f, "{}", item),
            RelayMessageUnionReader::GetRelayTransactionExtendedSketch(ref item) => {
                write!(f, "{}", item)
            }
            RelayMessageUnionReader::RelayTransactionSketchResult(ref item) => {
...
impl ::core::convert::From<RelayTransactionSalt> for RelayMessageUnion {
    fn from(item: RelayTransactionSalt) -> Self {
        RelayMessageUnion::RelayTransactionSalt(item)
    }
}
impl ::core::convert::From<GetRelayTransactionSketch> for RelayMessageUnion {
    fn from(item: GetRelayTransactionSketch) -> Self {
        RelayMessageUnion::GetRelayTransactionSketch(item)
    }
}
impl ::core::convert::From<RelayTransactionSketch> for RelayMessageUnion {
    fn from(item: RelayTransactionSketch) -> Self {
        RelayMessageUnion::RelayTransactionSketch(item)
    }
}
impl ::core::convert::From<GetRelayTransactionExtendedSketch> for RelayMessageUnion {
    fn from(item: GetRelayTransactionExtendedSketch) -> Self {
        RelayMessageUnion::GetRelayTransactionExtendedSketch(item)
    }
}
impl ::core::convert::From<RelayTransactionSketchResult> for RelayMessageUnion {
    fn from(item: RelayTransactionSketchResult) -> Self {
        RelayMessageUnion::RelayTransactionSketchResult(item)
    }
}
...
impl<'r> ::core::convert::From<RelayTransactionSaltReader<'r>> for RelayMessageUnionReader<'r> {
    fn from(item: RelayTransactionSaltReader<'r>) -> Self {
        RelayMessageUnionReader::RelayTransactionSalt(item)
    }
}
impl<'r> ::core::convert::From<GetRelayTransactionSketchReader<'r>>
    for RelayMessageUnionReader<'r>
{
    fn from(item: GetRelayTransactionSketchReader<'r>) -> Self {
        RelayMessageUnionReader::GetRelayTransactionSketch(item)
    }
}
impl<'r> ::core::convert::From<RelayTransactionSketchReader<'r>> for RelayMessageUnionReader<'r> {
    fn from(item: RelayTransactionSketchReader<'r>) -> Self {
        RelayMessageUnionReader::RelayTransactionSketch(item)
    }
}
impl<'r> ::core::convert::From<GetRelayTransactionExtendedSketchReader<'r>>
    for RelayMessageUnionReader<'r>
{
    fn from(item: GetRelayTransactionExtendedSketchReader<'r>) -> Self {
        RelayMessageUnionReader::GetRelayTransactionExtendedSketch(item)
    }
}
impl<'r> ::core::convert::From<RelayTransactionSketchResultReader<'r>>
    for RelayMessageUnionReader<'r>
{
    fn from(item: RelayTransactionSketchResultReader<'r>) -> Self {
        RelayMessageUnionReader::RelayTransactionSketchResult(item)
    }
}
impl RelayMessageUnion {
    ...
    pub fn as_bytes(&self) -> molecule::bytes::Bytes {
        match self {
            ...
            RelayMessageUnion::RelayTransactionSalt(item) => item.as_bytes(),
            RelayMessageUnion::GetRelayTransactionSketch(item) => item.as_bytes(),
            RelayMessageUnion::RelayTransactionSketch(item) => item.as_bytes(),
            RelayMessageUnion::GetRelayTransactionExtendedSketch(item) => item.as_bytes(),
            RelayMessageUnion::RelayTransactionSketchResult(item) => item.as_bytes(),
        }
    }
    pub fn as_slice(&self) -> &[u8] {
        match self {
            ...
            RelayMessageUnion::RelayTransactionSalt(item) => item.as_slice(),
            RelayMessageUnion::GetRelayTransactionSketch(item) => item.as_slice(),
            RelayMessageUnion::RelayTransactionSketch(item) => item.as_slice(),
            RelayMessageUnion::GetRelayTransactionExtendedSketch(item) => item.as_slice(),
            RelayMessageUnion::RelayTransactionSketchResult(item) => item.as_slice(),
        }
    }
    pub fn item_id(&self) -> molecule::Number {
        match self {
            ...
            RelayMessageUnion::RelayTransactionSalt(_) => 8,
            RelayMessageUnion::GetRelayTransactionSketch(_) => 9,
            RelayMessageUnion::RelayTransactionSketch(_) => 10,
            RelayMessageUnion::GetRelayTransactionExtendedSketch(_) => 11,
            RelayMessageUnion::RelayTransactionSketchResult(_) => 12,
        }
    }
    pub fn item_name(&self) -> &str {
        match self {
            ...
            RelayMessageUnion::RelayTransactionSalt(_) => "RelayTransactionSalt",
            RelayMessageUnion::GetRelayTransactionSketch(_) => "GetRelayTransactionSketch",
            RelayMessageUnion::RelayTransactionSketch(_) => "RelayTransactionSketch",
            RelayMessageUnion::GetRelayTransactionExtendedSketch(_) => {
                "GetRelayTransactionExtendedSketch"
            }
            RelayMessageUnion::RelayTransactionSketchResult(_) => "RelayTransactionSketchResult",
        }
    }
    pub fn as_reader<'r>(&'r self) -> RelayMessageUnionReader<'r> {
        match self {
            ...
            RelayMessageUnion::RelayTransactionSalt(item) => item.as_reader().into(),
            RelayMessageUnion::GetRelayTransactionSketch(item) => item.as_reader().into(),
            RelayMessageUnion::RelayTransactionSketch(item) => item.as_reader().into(),
            RelayMessageUnion::GetRelayTransactionExtendedSketch(item) => item.as_reader().into(),
            RelayMessageUnion::RelayTransactionSketchResult(item) => item.as_reader().into(),
        }
    }
}
impl<'r> RelayMessageUnionReader<'r> {
    ...
    pub fn as_slice(&self) -> &'r [u8] {
        match self {
            ...
            RelayMessageUnionReader::RelayTransactionSalt(item) => item.as_slice(),
            RelayMessageUnionReader::GetRelayTransactionSketch(item) => item.as_slice(),
            RelayMessageUnionReader::RelayTransactionSketch(item) => item.as_slice(),
            RelayMessageUnionReader::GetRelayTransactionExtendedSketch(item) => item.as_slice(),
            RelayMessageUnionReader::RelayTransactionSketchResult(item) => item.as_slice(),
        }
    }
    pub fn item_id(&self) -> molecule::Number {
        match self {
            ...
            RelayMessageUnionReader::RelayTransactionSalt(_) => 8,
            RelayMessageUnionReader::GetRelayTransactionSketch(_) => 9,
            RelayMessageUnionReader::RelayTransactionSketch(_) => 10,
            RelayMessageUnionReader::GetRelayTransactionExtendedSketch(_) => 11,
            RelayMessageUnionReader::RelayTransactionSketchResult(_) => 12,
        }
    }
    pub fn item_name(&self) -> &str {
        match self {
            ...
            RelayMessageUnionReader::RelayTransactionSalt(_) => "RelayTransactionSalt",
            RelayMessageUnionReader::GetRelayTransactionSketch(_) => "GetRelayTransactionSketch",
            RelayMessageUnionReader::RelayTransactionSketch(_) => "RelayTransactionSketch",
            RelayMessageUnionReader::GetRelayTransactionExtendedSketch(_) => {
                "GetRelayTransactionExtendedSketch"
            }
            RelayMessageUnionReader::RelayTransactionSketchResult(_) => {
                "RelayTransactionSketchResult"
            }
        }
    }
}
...
impl From<RelayTransactionSalt> for RelayMessage {
    fn from(value: RelayTransactionSalt) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<GetRelayTransactionSketch> for RelayMessage {
    fn from(value: GetRelayTransactionSketch) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<RelayTransactionSketch> for RelayMessage {
    fn from(value: RelayTransactionSketch) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<GetRelayTransactionExtendedSketch> for RelayMessage {
    fn from(value: GetRelayTransactionExtendedSketch) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<RelayTransactionSketchResult> for RelayMessage {
    fn from(value: RelayTransactionSketchResult) -> Self {
        Self::new_builder().set(value).build()
    }
}
#[derive(Clone)]
pub struct RelayTransactionSalt(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for RelayTransactionSalt {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for RelayTransactionSalt {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for RelayTransactionSalt {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
...
impl ::core::default::Default for RelayTransactionSalt {
    fn default() -> Self {
        let v = molecule::bytes::Bytes::from_static(&Self::DEFAULT_VALUE);
        RelayTransactionSalt::new_unchecked(v)
    }
}
impl RelayTransactionSalt {
    ...
    pub fn as_reader<'r>(&'r self) -> RelayTransactionSaltReader<'r> {
        RelayTransactionSaltReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for RelayTransactionSalt {
    type Builder = RelayTransactionSaltBuilder;
    const NAME: &'static str = "RelayTransactionSalt";
    fn new_unchecked(data: molecule::bytes::Bytes) -> Self {
        RelayTransactionSalt(data)
    }
    fn as_bytes(&self) -> molecule::bytes::Bytes {
        self.0.clone()
    }
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        RelayTransactionSaltReader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        RelayTransactionSaltReader::from_compatible_slice(slice).map(|reader| reader.to_entity())
    }
    fn new_builder() -> Self::Builder {
        ::core::default::Default::default()
    }
    fn as_builder(self) -> Self::Builder {
        Self::new_builder().salt(self.salt())
    }
}
#[derive(Clone, Copy)]
pub struct RelayTransactionSaltReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for RelayTransactionSaltReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for RelayTransactionSaltReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for RelayTransactionSaltReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "salt", self.salt())?;
        let extra_count = self.count_extra_fields();
...
impl<'r> RelayTransactionSaltReader<'r> {
    pub const FIELD_COUNT: usize = 1;
    pub fn total_size(&self) -> usize {
        molecule::unpack_number(self.as_slice()) as usize
    }
    ...
    pub fn salt(&self) -> Uint64Reader<'r> {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[4..]) as usize;
        if self.has_extra_fields() {
            let end = molecule::unpack_number(&slice[8..]) as usize;
...
impl<'r> molecule::prelude::Reader<'r> for RelayTransactionSaltReader<'r> {
    type Entity = RelayTransactionSalt;
    const NAME: &'static str = "RelayTransactionSaltReader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
        RelayTransactionSaltReader(slice)
    }
    fn as_slice(&self) -> &'r [u8] {
        self.0
    }
...
#[derive(Clone, Debug, Default)]
pub struct RelayTransactionSaltBuilder {
    pub(crate) salt: Uint64,
}
impl RelayTransactionSaltBuilder {
    pub const FIELD_COUNT: usize = 1;
    pub fn salt(mut self, v: Uint64) -> Self {
        self.salt = v;
        self
    }
}
impl molecule::prelude::Builder for RelayTransactionSaltBuilder {
    type Entity = RelayTransactionSalt;
    const NAME: &'static str = "RelayTransactionSaltBuilder";
    fn expected_length(&self) -> usize {
        molecule::NUMBER_SIZE * (Self::FIELD_COUNT + 1) + self.salt.as_slice().len()
    }
    fn write<W: molecule::io::Write>(&self, writer: &mut W) -> molecule::io::Result<()> {
        let mut total_size = molecule::NUMBER_SIZE * (Self::FIELD_COUNT + 1);
        let mut offsets = Vec::with_capacity(Self::FIELD_COUNT);
        offsets.push(total_size);
        total_size += self.salt.as_slice().len();
        writer.write_all(&molecule::pack_number(total_size as molecule::Number))?;
        for offset in offsets.into_iter() {
            writer.write_all(&molecule::pack_number(offset as molecule::Number))?;
        }
    ...
    fn build(&self) -> Self::Entity {
        ...
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        RelayTransactionSalt::new_unchecked(inner.into())
    }
}
#[derive(Clone)]
pub struct GetRelayTransactionSketch(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for GetRelayTransactionSketch {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for GetRelayTransactionSketch {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for GetRelayTransactionSketch {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
...
impl ::core::default::Default for GetRelayTransactionSketch {
    fn default() -> Self {
        let v = molecule::bytes::Bytes::from_static(&Self::DEFAULT_VALUE);
        GetRelayTransactionSketch::new_unchecked(v)
    }
}
impl GetRelayTransactionSketch {
    ...
    pub fn set_size(&self) -> Uint64 {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[4..]) as usize;
        let end = molecule::unpack_number(&slice[8..]) as usize;
        Uint64::new_unchecked(self.0.slice(start..end))
    }
    pub fn q(&self) -> Uint64 {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[8..]) as usize;
        if self.has_extra_fields() {
            let end = molecule::unpack_number(&slice[12..]) as usize;
    ...
    pub fn as_reader<'r>(&'r self) -> GetRelayTransactionSketchReader<'r> {
        GetRelayTransactionSketchReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for GetRelayTransactionSketch {
    type Builder = GetRelayTransactionSketchBuilder;
    const NAME: &'static str = "GetRelayTransactionSketch";
    fn new_unchecked(data: molecule::bytes::Bytes) -> Self {
        GetRelayTransactionSketch(data)
    }
    fn as_bytes(&self) -> molecule::bytes::Bytes {
        self.0.clone()
    }
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        GetRelayTransactionSketchReader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        GetRelayTransactionSketchReader::from_compatible_slice(slice)
    ...
    fn as_builder(self) -> Self::Builder {
        Self::new_builder().set_size(self.set_size()).q(self.q())
    }
}
#[derive(Clone, Copy)]
pub struct GetRelayTransactionSketchReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for GetRelayTransactionSketchReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for GetRelayTransactionSketchReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for GetRelayTransactionSketchReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "set_size", self.set_size())?;
        write!(f, ", {}: {}", "q", self.q())?;
...
impl<'r> GetRelayTransactionSketchReader<'r> {
    pub const FIELD_COUNT: usize = 2;
    pub fn total_size(&self) -> usize {
        molecule::unpack_number(self.as_slice()) as usize
    }
    ...
    pub fn set_size(&self) -> Uint64Reader<'r> {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[4..]) as usize;
        let end = molecule::unpack_number(&slice[8..]) as usize;
        Uint64Reader::new_unchecked(&self.as_slice()[start..end])
    }
    pub fn q(&self) -> Uint64Reader<'r> {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[8..]) as usize;
        if self.has_extra_fields() {
            let end = molecule::unpack_number(&slice[12..]) as usize;
...
impl<'r> molecule::prelude::Reader<'r> for GetRelayTransactionSketchReader<'r> {
    type Entity = GetRelayTransactionSketch;
    const NAME: &'static str = "GetRelayTransactionSketchReader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
        GetRelayTransactionSketchReader(slice)
    }
    fn as_slice(&self) -> &'r [u8] {
        self.0
    }
...
#[derive(Clone, Debug, Default)]
pub struct GetRelayTransactionSketchBuilder {
    pub(crate) set_size: Uint64,
    pub(crate) q: Uint64,
}
impl GetRelayTransactionSketchBuilder {
    pub const FIELD_COUNT: usize = 2;
    pub fn set_size(mut self, v: Uint64) -> Self {
        self.set_size = v;
        self
    }
    pub fn q(mut self, v: Uint64) -> Self {
        self.q = v;
        self
    }
}
impl molecule::prelude::Builder for GetRelayTransactionSketchBuilder {
    type Entity = GetRelayTransactionSketch;
    const NAME: &'static str = "GetRelayTransactionSketchBuilder";
    fn expected_length(&self) -> usize {
        molecule::NUMBER_SIZE * (Self::FIELD_COUNT + 1)
    ...
    fn write<W: molecule::io::Write>(&self, writer: &mut W) -> molecule::io::Result<()> {
        ...
        offsets.push(total_size);
        total_size += self.q.as_slice().len();
        writer.write_all(&molecule::pack_number(total_size as molecule::Number))?;
        for offset in offsets.into_iter() {
            writer.write_all(&molecule::pack_number(offset as molecule::Number))?;
        }
        writer.write_all(self.set_size.as_slice())?;
        writer.write_all(self.q.as_slice())?;
        Ok(())
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        GetRelayTransactionSketch::new_unchecked(inner.into())
    }
}
#[derive(Clone)]
pub struct RelayTransactionSketch(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for RelayTransactionSketch {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for RelayTransactionSketch {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for RelayTransactionSketch {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
...
impl ::core::default::Default for RelayTransactionSketch {
    fn default() -> Self {
        let v = molecule::bytes::Bytes::from_static(&Self::DEFAULT_VALUE);
        RelayTransactionSketch::new_unchecked(v)
    }
}
impl RelayTransactionSketch {
    ...
    pub fn as_reader<'r>(&'r self) -> RelayTransactionSketchReader<'r> {
        RelayTransactionSketchReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for RelayTransactionSketch {
    type Builder = RelayTransactionSketchBuilder;
    const NAME: &'static str = "RelayTransactionSketch";
    fn new_unchecked(data: molecule::bytes::Bytes) -> Self {
        RelayTransactionSketch(data)
    }
    fn as_bytes(&self) -> molecule::bytes::Bytes {
        self.0.clone()
    }
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        RelayTransactionSketchReader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        RelayTransactionSketchReader::from_compatible_slice(slice).map(|reader| reader.to_entity())
    }
    fn new_builder() -> Self::Builder {
        ::core::default::Default::default()
    }
    fn as_builder(self) -> Self::Builder {
        Self::new_builder().short_id_sketch(self.short_id_sketch())
    }
}
#[derive(Clone, Copy)]
pub struct RelayTransactionSketchReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for RelayTransactionSketchReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for RelayTransactionSketchReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for RelayTransactionSketchReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "short_id_sketch", self.short_id_sketch())?;
        let extra_count = self.count_extra_fields();
...
impl<'r> molecule::prelude::Reader<'r> for RelayTransactionSketchReader<'r> {
    type Entity = RelayTransactionSketch;
    const NAME: &'static str = "RelayTransactionSketchReader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
        RelayTransactionSketchReader(slice)
    }
    fn as_slice(&self) -> &'r [u8] {
        self.0
    }
...
impl molecule::prelude::Builder for RelayTransactionSketchBuilder {
    type Entity = RelayTransactionSketch;
    const NAME: &'static str = "RelayTransactionSketchBuilder";
    fn expected_length(&self) -> usize {
        molecule::NUMBER_SIZE * (Self::FIELD_COUNT + 1) + self.short_id_sketch.as_slice().len()
    }
    fn write<W: molecule::io::Write>(&self, writer: &mut W) -> molecule::io::Result<()> {
        let mut total_size = molecule::NUMBER_SIZE * (Self::FIELD_COUNT + 1);
        let mut offsets = Vec::with_capacity(Self::FIELD_COUNT);
    ...
    fn build(&self) -> Self::Entity {
        ...
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        RelayTransactionSketch::new_unchecked(inner.into())
    }
}
#[derive(Clone)]
pub struct GetRelayTransactionExtendedSketch(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for GetRelayTransactionExtendedSketch {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for GetRelayTransactionExtendedSketch {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for GetRelayTransactionExtendedSketch {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        let extra_count = self.count_extra_fields();
        if extra_count != 0 {
...
impl ::core::default::Default for GetRelayTransactionExtendedSketch {
    fn default() -> Self {
        let v = molecule::bytes::Bytes::from_static(&Self::DEFAULT_VALUE);
        GetRelayTransactionExtendedSketch::new_unchecked(v)
    }
}
impl GetRelayTransactionExtendedSketch {
    ...
    pub fn as_reader<'r>(&'r self) -> GetRelayTransactionExtendedSketchReader<'r> {
        GetRelayTransactionExtendedSketchReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for GetRelayTransactionExtendedSketch {
    type Builder = GetRelayTransactionExtendedSketchBuilder;
    const NAME: &'static str = "GetRelayTransactionExtendedSketch";
    fn new_unchecked(data: molecule::bytes::Bytes) -> Self {
        GetRelayTransactionExtendedSketch(data)
    }
    fn as_bytes(&self) -> molecule::bytes::Bytes {
        self.0.clone()
    }
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        GetRelayTransactionExtendedSketchReader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        GetRelayTransactionExtendedSketchReader::from_compatible_slice(slice)
            .map(|reader| reader.to_entity())
    }
    fn new_builder() -> Self::Builder {
        ::core::default::Default::default()
...
#[derive(Clone, Copy)]
pub struct GetRelayTransactionExtendedSketchReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for GetRelayTransactionExtendedSketchReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for GetRelayTransactionExtendedSketchReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for GetRelayTransactionExtendedSketchReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        let extra_count = self.count_extra_fields();
        if extra_count != 0 {
...
impl<'r> GetRelayTransactionExtendedSketchReader<'r> {
    pub const FIELD_COUNT: usize = 0;
    pub fn total_size(&self) -> usize {
        molecule::unpack_number(self.as_slice()) as usize
    }
...
impl<'r> molecule::prelude::Reader<'r> for GetRelayTransactionExtendedSketchReader<'r> {
    type Entity = GetRelayTransactionExtendedSketch;
    const NAME: &'static str = "GetRelayTransactionExtendedSketchReader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
        GetRelayTransactionExtendedSketchReader(slice)
    }
    fn as_slice(&self) -> &'r [u8] {
        self.0
    }
...
#[derive(Clone, Debug, Default)]
pub struct GetRelayTransactionExtendedSketchBuilder {}
impl GetRelayTransactionExtendedSketchBuilder {
    pub const FIELD_COUNT: usize = 0;
}
impl molecule::prelude::Builder for GetRelayTransactionExtendedSketchBuilder {
    type Entity = GetRelayTransactionExtendedSketch;
    const NAME: &'static str = "GetRelayTransactionExtendedSketchBuilder";
    fn expected_length(&self) -> usize {
    ...
    fn build(&self) -> Self::Entity {
        ...
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        GetRelayTransactionExtendedSketch::new_unchecked(inner.into())
    }
}
#[derive(Clone)]
pub struct RelayTransactionSketchResult(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for RelayTransactionSketchResult {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for RelayTransactionSketchResult {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for RelayTransactionSketchResult {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "success", self.success())?;
        write!(f, ", {}: {}", "missing_short_ids", self.missing_short_ids())?;
        let extra_count = self.count_extra_fields();
        if extra_count != 0 {
            write!(f, ", .. ({} fields)", extra_count)?;
        }
...
impl ::core::default::Default for RelayTransactionSketchResult {
    fn default() -> Self {
        let v = molecule::bytes::Bytes::from_static(&Self::DEFAULT_VALUE);
        RelayTransactionSketchResult::new_unchecked(v)
    }
}
impl RelayTransactionSketchResult {
    ...
    pub fn as_reader<'r>(&'r self) -> RelayTransactionSketchResultReader<'r> {
        RelayTransactionSketchResultReader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for RelayTransactionSketchResult {
    type Builder = RelayTransactionSketchResultBuilder;
    const NAME: &'static str = "RelayTransactionSketchResult";
    fn new_unchecked(data: molecule::bytes::Bytes) -> Self {
        RelayTransactionSketchResult(data)
    }
    fn as_bytes(&self) -> molecule::bytes::Bytes {
        self.0.clone()
    }
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        RelayTransactionSketchResultReader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        RelayTransactionSketchResultReader::from_compatible_slice(slice)
            .map(|reader| reader.to_entity())
    }
    fn new_builder() -> Self::Builder {
        ::core::default::Default::default()
    ...
    fn as_builder(self) -> Self::Builder {
        Self::new_builder()
            ...
            .missing_short_ids(self.missing_short_ids())
    }
}
#[derive(Clone, Copy)]
pub struct RelayTransactionSketchResultReader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for RelayTransactionSketchResultReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for RelayTransactionSketchResultReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for RelayTransactionSketchResultReader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} {{ ", Self::NAME)?;
        write!(f, "{}: {}", "success", self.success())?;
        write!(f, ", {}: {}", "missing_short_ids", self.missing_short_ids())?;
...
impl<'r> RelayTransactionSketchResultReader<'r> {
    pub const FIELD_COUNT: usize = 2;
    pub fn total_size(&self) -> usize {
        molecule::unpack_number(self.as_slice()) as usize
    }
    ...
    pub fn success(&self) -> BoolReader<'r> {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[4..]) as usize;
        let end = molecule::unpack_number(&slice[8..]) as usize;
...
impl<'r> molecule::prelude::Reader<'r> for RelayTransactionSketchResultReader<'r> {
    type Entity = RelayTransactionSketchResult;
    const NAME: &'static str = "RelayTransactionSketchResultReader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
        RelayTransactionSketchResultReader(slice)
    }
    fn as_slice(&self) -> &'r [u8] {
        self.0
    }
...
impl molecule::prelude::Builder for RelayTransactionSketchResultBuilder {
    type Entity = RelayTransactionSketchResult;
    const NAME: &'static str = "RelayTransactionSketchResultBuilder";
    fn expected_length(&self) -> usize {
        molecule::NUMBER_SIZE * (Self::FIELD_COUNT + 1)
            + self.success.as_slice().len()
            + self.missing_short_ids.as_slice().len()
    }
    fn write<W: molecule::io::Write>(&self, writer: &mut W) -> molecule::io::Result<()> {
        let mut total_size = molecule::NUMBER_SIZE * (Self::FIELD_COUNT + 1);
        let mut offsets = Vec::with_capacity(Self::FIELD_COUNT);
        offsets.push(total_size);
        total_size += self.success.as_slice().len();
        offsets.push(total_size);
        total_size += self.missing_short_ids.as_slice().len();
        writer.write_all(&molecule::pack_number(total_size as molecule::Number))?;
        for offset in offsets.into_iter() {
            writer.write_all(&molecule::pack_number(offset as molecule::Number))?;
        }
        writer.write_all(self.success.as_slice())?;
        writer.write_all(self.missing_short_ids.as_slice())?;
        Ok(())
    }
    fn build(&self) -> Self::Entity {
        let mut inner = Vec::with_capacity(self.expected_length());
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        RelayTransactionSketchResult::new_unchecked(inner.into())
    }
}
#[derive(Clone)]
